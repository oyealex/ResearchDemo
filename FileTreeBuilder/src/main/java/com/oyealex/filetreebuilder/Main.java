...
import com.oyealex.filetreebuilder.singlefolerbuild.SingleFolderBuildContext;
import com.oyealex.filetreebuilder.singlefolerbuild.SingleFolderBuildParam;
...
public class Main implements Constants {
    ...
    private static SingleFolderBuildContext parseFromArgs(String[] args) {
        if (args.length < 8) {
            log.info("java -jar x.jar basePath filePrefix fileSize amount startIndex parallel subFolderPrefix subFolderStartIndex");
            System.exit(0);
        }
