...
public class HugePathTypeHandler implements TypeHandler<List<TaskHugePath.HugePath>> {
    ...
    @Override
    public void setParameter(PreparedStatement ps, int i, List<TaskHugePath.HugePath> parameter, JdbcType jdbcType) throws SQLException {
    ...
    public List<TaskHugePath.HugePath> getResult(ResultSet rs, String columnName) throws SQLException {
        ...
        Type type = new TypeToken<ArrayList<TaskHugePath.HugePath>>(){}.getType();
